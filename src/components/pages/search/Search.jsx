                ...
                foodArr.map((item, index) => {
                    return (
                        <div className='recpiseDIV' style={{ display: 'flex', flexDirection: 'row', display: 'inline-block', margin: 'auto'}}>
                            <Card className='cardStyly' style={{ width: '20.2rem', margin: "30px", marginLeft: "20%", marginBottom: '30px', border: 'solid #e6e6e6', flex: '1', boxShadow: "3px 2px 3px 2px rgba(230, 230, 230, 0.87)" }}>
                                <Card.Img className='img-card' variant="top" src={item.recipe.image} style={{ width: '19.9rem', height: '15rem', margin: 'auto', boxShadow: "0px 10px 5px #f5f5f0"}} />
                                <Card.Body>
